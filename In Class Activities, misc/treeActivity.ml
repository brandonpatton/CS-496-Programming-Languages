...
let t : int tree = Node(74, Node(50, Empty, Node(62, Empty, Empty)),
		Node(88, Node(83, Empty, Empty), Empty))

let rec find : 'a -> 'a tree -> bool = fun k t -> match t with
	| Empty -> false
...
let rec add : 'a -> 'a tree -> 'a tree = fun k t -> match t with
